...
-- Database: idempiereTAM10pro
DROP DATABASE "idempiereTAM10pro";
-- OR RENAME
ALTER DATABASE "idempiereTAM10pro"
RENAME TO "idempiereTAM10pro2";
--CREATE
CREATE DATABASE "idempiereTAM10pro"
    WITH 
    OWNER = adempiere
    ENCODING = 'UTF8'
...
psql -p 5433 -d idempiereTAM10pro -f idempiereTAM10pro_2023_10_26_2315_psql ;
...
# /opt/PostgreSQL/10/bin/psql -p 5432 -U adempiere idempiereTAM10pro
