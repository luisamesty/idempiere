...
// IDEMPIERE-4083	"currencyBase(p.PayAmt,p.C_Currency_ID,p.DateTrx, p.AD_Client_ID,p.AD_Org_ID)", BigDecimal.class),
			"currencyconvertpayment(p.C_Payment_ID, p.C_Currency_ID, p.PayAmt, p.DateTrx)", BigDecimal.class),
