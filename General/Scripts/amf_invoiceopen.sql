-- Function: amf_invoiceopen(numeric, numeric)
-- Verify isSeniatBook: 
--	C Credit Memo
--	D Debit Memo
--	I Invoice
...
-- DROP FUNCTION IF EXISTS amf_invoiceopen(numeric, numeric);
CREATE OR REPLACE FUNCTION adempiere.amf_invoiceopen(
...
END;
$BODY$ ;
ALTER FUNCTION adempiere.amf_invoiceopen(numeric, numeric)
  OWNER TO adempiere;
