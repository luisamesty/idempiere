-- FUNCTION: adempiere.paymentavailable(numeric)

-- DROP FUNCTION adempiere.paymentavailable(numeric);

CREATE OR REPLACE FUNCTION adempiere.paymentavailable(
...
ALTER FUNCTION adempiere.paymentavailable(numeric)
    OWNER TO adempiere;
